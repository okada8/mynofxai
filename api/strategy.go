...
func (s *Server) handleCreateStrategy(c *gin.Context) {
	...
	s.logAudit(c, "CREATE_STRATEGY", strategy.ID, "SUCCESS", req)
...
func (s *Server) handleUpdateStrategy(c *gin.Context) {
	...
	s.logAudit(c, "UPDATE_STRATEGY", strategyID, "SUCCESS", req)
...
func (s *Server) handleDeleteStrategy(c *gin.Context) {
	...
	s.logAudit(c, "DELETE_STRATEGY", strategyID, "SUCCESS", nil)
...
func (s *Server) handleActivateStrategy(c *gin.Context) {
	...
	s.logAudit(c, "ACTIVATE_STRATEGY", strategyID, "SUCCESS", nil)
...
func (s *Server) handleDuplicateStrategy(c *gin.Context) {
	...
	s.logAudit(c, "DUPLICATE_STRATEGY", newID, "SUCCESS", gin.H{"source_id": sourceID, "new_name": req.Name})
...
func (s *Server) handlePreviewPrompt(c *gin.Context) {
	...
	s.logAudit(c, "PREVIEW_PROMPT", "strategy_preview", "SUCCESS", gin.H{
...
func (s *Server) handleStrategyTestRun(c *gin.Context) {
	...
	if req.RunRealAI && req.AIModelID != "" {
		...
		if aiErr != nil {
			s.logAudit(c, "TEST_RUN_STRATEGY", "strategy_test", "FAILED", gin.H{
		...
		s.logAudit(c, "TEST_RUN_STRATEGY", "strategy_test", "SUCCESS", gin.H{
			"ai_model":    req.AIModelID,
			"run_real_ai": true,
		})
