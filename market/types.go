...
type TimeframeSeriesData struct {
	...
	ADX14Values []float64  `json:"adx14_values"` // ADX14 series (new)
	VWAPValues  []float64  `json:"vwap_values"`  // VWAP series (new)
	OBVValues   []float64  `json:"obv_values"`   // OBV series (new)
	CMF20Values []float64  `json:"cmf20_values"` // CMF20 series (new)
